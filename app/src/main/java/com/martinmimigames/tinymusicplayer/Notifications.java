...
class Notifications {
   ...
   * @param nextIntent      pending intent for playing next track
   */
  void setupNotificationBuilder(String title, PendingIntent playPauseIntent, PendingIntent killIntent, PendingIntent loopIntent, PendingIntent shuffleIntent, PendingIntent nextIntent) {
  ...
  void getNotification(final Uri uri) {
    ...
    var nextIntent = genIntent(5, Launcher.NEXT);

    setupNotificationBuilder(title, playPauseIntent, killIntent, loopIntent, shuffleIntent, nextIntent);
    genNotification();
