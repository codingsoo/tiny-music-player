...
class Notifications {
   ...
   * @param hasPlaylist     whether there are multiple tracks
   */
  void setupNotificationBuilder(String title, PendingIntent playPauseIntent, PendingIntent killIntent, 
                                 ...
                                 PendingIntent prevIntent, PendingIntent nextIntent, boolean hasPlaylist) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
      ...
      // Add navigation controls if playlist has multiple tracks
      if (hasPlaylist) {
        builder.addAction(0, "prev", prevIntent);
        builder.addAction(0, "next", nextIntent);
   ...
   */
  void getNotification(final Uri uri, boolean hasPlaylist) {
    ...
    setupNotificationBuilder(title, playPauseIntent, killIntent, loopIntent, shuffleIntent, prevIntent, nextIntent, hasPlaylist);
    genNotification();
