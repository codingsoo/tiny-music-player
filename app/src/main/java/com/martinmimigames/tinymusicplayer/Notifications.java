...
class Notifications {
   ...
   */
  void getNotification(final Uri uri, boolean multipleTracks) {
    this.hasMultipleTracks = multipleTracks;
    ...
    setupNotificationBuilder(currentTitle, playPauseIntent, killIntent, loopIntent, shuffleIntent, prevIntent, nextIntent);
    genNotification();
